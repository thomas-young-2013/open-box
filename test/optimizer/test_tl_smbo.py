...
bo = SMBO(branin, cs, surrogate_type='prf', max_runs=50, time_limit_per_trial=3, logging_dir='logs')
bo.run()
...
tlbo = SMBO(branin, cs, history_bo_data=[hist1], surrogate_type='tlbo_prf',
