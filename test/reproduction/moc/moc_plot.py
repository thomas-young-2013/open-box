...
python test/reproduction/moc/moc_plot.py --mths botorch,hypermapper,litebo --problem c2dtlz2-3-2 --n 200
...
default_mths = 'botorch,hypermapper,litebo'
parser = argparse.ArgumentParser()
parser.add_argument('--n', type=int, default=200)
parser.add_argument('--mths', type=str, default=default_mths)
parser.add_argument('--problem', type=str, default='c2dtlz2-3-2')
